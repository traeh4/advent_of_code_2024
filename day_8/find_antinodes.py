    ...
    for antenna, locs in frequency_dict.items():
        for i in range(len(locs) - 1):
            for j in range(i + 1, len(locs)):
                ...
                if antinode_1[0] in range(50) and antinode_1[1] in range(50) and antinode_1 not in antinodes:
                    antinodes.append(antinode_1)
                if antinode_2[0] in range(50) and antinode_2[1] in range(50) and antinode_2 not in antinodes:
